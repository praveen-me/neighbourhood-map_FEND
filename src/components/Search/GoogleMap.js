...
class GoogleMap extends Component {
  ...
  componentDidMount() {
    ...
    if (typeof window.google === 'object' && typeof window.google.maps === 'object') {
      ...
      this.loadGoogleMapAPIJS('https://maps.googleapis.com/maps/api/js?key=AIzaSyAqFH57NieLBct-OUiod6-U3rxvsgQ4O_s&callback=initMap');
    }
  }
  ...
  initMap = () => {
    ...
    const map = new window.google.maps.Map(this.myMapContainer.current, {
      center: { lat: 32.2190, lng: 76.3234 },
      zoom: 6,
    });
